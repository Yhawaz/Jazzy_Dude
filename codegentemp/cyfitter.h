...
/* SaxDac_viDAC8 */
#define SaxDac_viDAC8__CR0 CYREG_DAC0_CR0
#define SaxDac_viDAC8__CR1 CYREG_DAC0_CR1
#define SaxDac_viDAC8__D CYREG_DAC0_D
#define SaxDac_viDAC8__PM_ACT_CFG CYREG_PM_ACT_CFG8
#define SaxDac_viDAC8__PM_ACT_MSK 0x01u
#define SaxDac_viDAC8__PM_STBY_CFG CYREG_PM_STBY_CFG8
#define SaxDac_viDAC8__PM_STBY_MSK 0x01u
#define SaxDac_viDAC8__STROBE CYREG_DAC0_STROBE
#define SaxDac_viDAC8__SW0 CYREG_DAC0_SW0
#define SaxDac_viDAC8__SW2 CYREG_DAC0_SW2
#define SaxDac_viDAC8__SW3 CYREG_DAC0_SW3
#define SaxDac_viDAC8__SW4 CYREG_DAC0_SW4
#define SaxDac_viDAC8__TR CYREG_DAC0_TR
#define SaxDac_viDAC8__TRIM__M1 CYREG_FLSHID_CUST_TABLES_DAC0_M1
#define SaxDac_viDAC8__TRIM__M2 CYREG_FLSHID_CUST_TABLES_DAC0_M2
#define SaxDac_viDAC8__TRIM__M3 CYREG_FLSHID_CUST_TABLES_DAC0_M3
#define SaxDac_viDAC8__TRIM__M4 CYREG_FLSHID_CUST_TABLES_DAC0_M4
#define SaxDac_viDAC8__TRIM__M5 CYREG_FLSHID_CUST_TABLES_DAC0_M5
#define SaxDac_viDAC8__TRIM__M6 CYREG_FLSHID_CUST_TABLES_DAC0_M6
#define SaxDac_viDAC8__TRIM__M7 CYREG_FLSHID_CUST_TABLES_DAC0_M7
#define SaxDac_viDAC8__TRIM__M8 CYREG_FLSHID_CUST_TABLES_DAC0_M8
...
#define lcd_isr__INTC_MASK 0x01u
#define lcd_isr__INTC_NUMBER 0u
#define lcd_isr__INTC_PRIOR_NUM 7u
#define lcd_isr__INTC_PRIOR_REG CYREG_NVIC_PRI_0
#define lcd_isr__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define lcd_isr__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* sax_clk */
#define sax_clk__CFG0 CYREG_CLKDIST_DCFG0_CFG0
#define sax_clk__CFG1 CYREG_CLKDIST_DCFG0_CFG1
#define sax_clk__CFG2 CYREG_CLKDIST_DCFG0_CFG2
#define sax_clk__CFG2_SRC_SEL_MASK 0x07u
#define sax_clk__INDEX 0x00u
#define sax_clk__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define sax_clk__PM_ACT_MSK 0x01u
#define sax_clk__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define sax_clk__PM_STBY_MSK 0x01u
...
#define Audio_Out__0__MASK 0x01u
#define Audio_Out__0__PC CYREG_PRT6_PC0
#define Audio_Out__0__PORT 6u
#define Audio_Out__0__SHIFT 0u
#define Audio_Out__AG CYREG_PRT6_AG
#define Audio_Out__AMUX CYREG_PRT6_AMUX
#define Audio_Out__BIE CYREG_PRT6_BIE
#define Audio_Out__BIT_MASK CYREG_PRT6_BIT_MASK
#define Audio_Out__BYP CYREG_PRT6_BYP
#define Audio_Out__CTL CYREG_PRT6_CTL
#define Audio_Out__DM0 CYREG_PRT6_DM0
#define Audio_Out__DM1 CYREG_PRT6_DM1
#define Audio_Out__DM2 CYREG_PRT6_DM2
#define Audio_Out__DR CYREG_PRT6_DR
#define Audio_Out__INP_DIS CYREG_PRT6_INP_DIS
#define Audio_Out__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU6_BASE
#define Audio_Out__LCD_COM_SEG CYREG_PRT6_LCD_COM_SEG
#define Audio_Out__LCD_EN CYREG_PRT6_LCD_EN
#define Audio_Out__MASK 0x01u
#define Audio_Out__PORT 6u
#define Audio_Out__PRT CYREG_PRT6_PRT
#define Audio_Out__PRTDSI__CAPS_SEL CYREG_PRT6_CAPS_SEL
#define Audio_Out__PRTDSI__DBL_SYNC_IN CYREG_PRT6_DBL_SYNC_IN
#define Audio_Out__PRTDSI__OE_SEL0 CYREG_PRT6_OE_SEL0
#define Audio_Out__PRTDSI__OE_SEL1 CYREG_PRT6_OE_SEL1
#define Audio_Out__PRTDSI__OUT_SEL0 CYREG_PRT6_OUT_SEL0
#define Audio_Out__PRTDSI__OUT_SEL1 CYREG_PRT6_OUT_SEL1
#define Audio_Out__PRTDSI__SYNC_OUT CYREG_PRT6_SYNC_OUT
