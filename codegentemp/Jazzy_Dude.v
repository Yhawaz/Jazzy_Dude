...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=0, VDAC_Speed=2, Voltage=400, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SaxDac, CY_INSTANCE_SHORT_NAME=SaxDac, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=SaxDac, )
...
module ADC_SAR_v3_0_4 (
	...
	cy_psoc3_pins_v1_10
		#(.id("27a671b0-e426-4df5-b5f7-411e6f0ff057/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
    ...
    VDAC8_v1_90_0 SaxDac (
        ...
        .data(8'b00000000),
        .vOut(Net_711));
    defparam SaxDac.Data_Source = 0;
    defparam SaxDac.Initial_Value = 100;
    defparam SaxDac.Strobe_Mode = 0;
	...
	wire [0:0] tmpOE__Audio_Out1_net;
	wire [0:0] tmpFB_0__Audio_Out1_net;
	wire [0:0] tmpIO_0__Audio_Out1_net;
	wire [0:0] tmpINTERRUPT_0__Audio_Out1_net;
	electrical [0:0] tmpSIOVREF__Audio_Out1_net;
	...
	cy_psoc3_pins_v1_10
		...
		Audio_Out1
		 (.oe(tmpOE__Audio_Out1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Audio_Out1_net[0:0]}),
		  .analog({Net_711}),
		  .io({tmpIO_0__Audio_Out1_net[0:0]}),
		  .siovref(tmpSIOVREF__Audio_Out1_net),
		  .interrupt({tmpINTERRUPT_0__Audio_Out1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Audio_Out1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__testy_net;
	wire [0:0] tmpFB_0__testy_net;
	wire [0:0] tmpIO_0__testy_net;
	wire [0:0] tmpINTERRUPT_0__testy_net;
	electrical [0:0] tmpSIOVREF__testy_net;
	...
	cy_psoc3_pins_v1_10
		...
		testy
		 (.oe(tmpOE__testy_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__testy_net[0:0]}),
		  .io({tmpIO_0__testy_net[0:0]}),
		  .siovref(tmpSIOVREF__testy_net),
		  .interrupt({tmpINTERRUPT_0__testy_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	cy_psoc3_pins_v1_10
		#(.id("935f2446-4c52-46c5-b8b6-ac969621b398"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6b9cedab-e166-46a4-a1a5-fe5511a5835f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Audio_Out2_net;
	wire [0:0] tmpFB_0__Audio_Out2_net;
	wire [0:0] tmpIO_0__Audio_Out2_net;
	wire [0:0] tmpINTERRUPT_0__Audio_Out2_net;
	electrical [0:0] tmpSIOVREF__Audio_Out2_net;

	cy_psoc3_pins_v1_10
		#(.id("31550cba-a89e-4c78-aa45-5fd3c54fc590"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Audio_Out2
		 (.oe(tmpOE__Audio_Out2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Audio_Out2_net[0:0]}),
		  .analog({Net_1009}),
		  .io({tmpIO_0__Audio_Out2_net[0:0]}),
		  .siovref(tmpSIOVREF__Audio_Out2_net),
		  .interrupt({tmpINTERRUPT_0__Audio_Out2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Audio_Out2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("689b1eb3-f4fc-4e45-aee3-dd895b2fb710"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Mode_Switch_net;
	wire [0:0] tmpIO_0__Mode_Switch_net;
	wire [0:0] tmpINTERRUPT_0__Mode_Switch_net;
	electrical [0:0] tmpSIOVREF__Mode_Switch_net;

	cy_psoc3_pins_v1_10
		#(.id("4fe81b6c-ef7c-465f-a5f5-d38067f15bd9"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Mode_Switch
		 (.oe(tmpOE__Mode_Switch_net),
		  .y({1'b0}),
		  .fb({Net_1112}),
		  .io({tmpIO_0__Mode_Switch_net[0:0]}),
		  .siovref(tmpSIOVREF__Mode_Switch_net),
		  .interrupt({tmpINTERRUPT_0__Mode_Switch_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Mode_Switch_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("a38750d4-7b95-4753-97eb-0a06f48c500c"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Inst_Switch_net;
	wire [0:0] tmpIO_0__Inst_Switch_net;
	wire [0:0] tmpINTERRUPT_0__Inst_Switch_net;
	electrical [0:0] tmpSIOVREF__Inst_Switch_net;

	cy_psoc3_pins_v1_10
		#(.id("6bc7ee63-7f91-4349-8afb-9cc05e9029a9"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Inst_Switch
		 (.oe(tmpOE__Inst_Switch_net),
		  .y({1'b0}),
		  .fb({Net_1119}),
		  .io({tmpIO_0__Inst_Switch_net[0:0]}),
		  .siovref(tmpSIOVREF__Inst_Switch_net),
		  .interrupt({tmpINTERRUPT_0__Inst_Switch_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Inst_Switch_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
