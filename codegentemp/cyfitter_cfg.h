...
extern void BPM_ADC_AMux_Set(uint8 channel);
extern void BPM_ADC_AMux_Unset(uint8 channel);
/* BPM_ADC_AMux__addrTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern uint8 CYXDATA * const CYCODE BPM_ADC_AMux__addrTable[2];
/* BPM_ADC_AMux__maskTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern const uint8 CYCODE BPM_ADC_AMux__maskTable[2];
