...
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x480000E4u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG2_CFG0), 0x007Cu);
	CY_SET_XTND_REG8((void CYFAR *)(CYREG_CLKDIST_DCFG2_CFG0 + 0x2u), 0x19u);
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG3_CFG0), 0x014Cu);
	CY_SET_XTND_REG8((void CYFAR *)(CYREG_CLKDIST_DCFG3_CFG0 + 0x2u), 0x19u);
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG4_CFG0), 0x0020u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT3_AMUX, 0x8440u);
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_CMP1_SW0, 0x82u);
...
uint8 CYXDATA * const CYCODE BPM_ADC_AMux__addrTable[2] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE BPM_ADC_AMux__maskTable[2] = {
	0x40u, 
	0x00u, 
};

/*******************************************************************************
* Function Name: BPM_ADC_AMux_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void BPM_ADC_AMux_Set(uint8 channel)
{
	if (channel < 2)
	{
		*BPM_ADC_AMux__addrTable[channel] |= BPM_ADC_AMux__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: BPM_ADC_AMux_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void BPM_ADC_AMux_Unset(uint8 channel)
{
	if (channel < 2)
	{
		*BPM_ADC_AMux__addrTable[channel] &= (uint8)~BPM_ADC_AMux__maskTable[channel];
	}
}
