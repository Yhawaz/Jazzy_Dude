...
{
    uint8 staticBits = (Mode_Switch_DR & (uint8)(~Mode_Switch_MASK));
    Mode_Switch_DR = staticBits | ((uint8)(value << Mode_Switch_SHIFT) & Mode_Switch_MASK);
}
...
{
	CyPins_SetPinDriveMode(Mode_Switch_0, mode);
}
...
{
    return (Mode_Switch_PS & Mode_Switch_MASK) >> Mode_Switch_SHIFT;
}
...
{
    return (Mode_Switch_DR & Mode_Switch_MASK) >> Mode_Switch_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(Mode_Switch_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Mode_Switch_0_INTR) != 0u) 
		{ 
			 Mode_Switch_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (Mode_Switch_INTSTAT & Mode_Switch_MASK) >> Mode_Switch_SHIFT;
    }
